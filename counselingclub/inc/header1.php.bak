...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>UiTM PERLIS COUNSELING APPOINTMENT SYSTEM.</title>
	<!-- Favicons -->
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php }else{ ?>
              ...
              <?php
                         ...
                         ?>">
                <a class="nav-link" href="register_admin.php"><i class="fas fa-user-plus mr-2"></i>Register</a>
              </li>
              <li class="nav-item
                <?php
                    			 ...
                    			 ?>">
                <a class="nav-link" href="login_admin.php"><i class="fas fa-sign-in-alt mr-2"></i>Login</a>
              </li>
